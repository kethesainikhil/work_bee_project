    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-4 group">
              <div className="relative">
                <div className="w-9 h-9 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 transition-all duration-500 overflow-hidden">
                  <img 
                    src={workbeeLogo} 
                    alt="WorkBee Logo" 
                    className="w-7 h-7 sm:w-8 sm:h-8 lg:w-9 lg:h-9 object-contain drop-shadow-lg filter brightness-110"
                  />
                </div>
              </div>
              <div className="transition-all duration-300">
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-black text-white tracking-tight bg-gradient-to-r from-white to-blue-100 bg-clip-text">
                  Work<span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">Bee</span>
                </h1>
            ...
            <div className="hidden lg:flex items-center gap-6 xl:gap-8">
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2 text-white/90 text-sm font-medium bg-white/5 px-3 py-2 rounded-full border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
            ...
            <div className="hidden sm:flex items-center gap-2 lg:gap-3">
              <Button
                ...
                className="text-white hover:bg-white/15 hover:text-amber-300 border border-white/20 hover:border-amber-300/60 transition-all duration-300 font-semibold px-4 lg:px-6 py-2 rounded-full backdrop-blur-sm hover:shadow-lg hover:scale-105 group"
              >
              ...
              <Button
                ...
                className="bg-gradient-to-r from-amber-500 via-amber-600 to-orange-500 hover:from-amber-600 hover:via-orange-500 hover:to-orange-600 text-white font-bold px-4 lg:px-6 py-2 rounded-full shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-300 border-0 relative overflow-hidden group"
              >
                ...
                <Briefcase className="w-4 h-4 mr-2 relative z-10 group-hover:scale-110 transition-transform duration-300" />
                <span className="relative z-10 text-sm lg:text-base">Hire Workers</span>
              </Button>
            </div>
            ...
            <div className="sm:hidden mt-4 pb-4 border-t border-white/10 pt-4 animate-fade-in bg-gradient-to-b from-white/5 to-transparent rounded-b-2xl backdrop-blur-sm">
              <div className="flex flex-col gap-3">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-amber-500 via-amber-600 to-orange-500 hover:from-amber-600 hover:via-orange-500 hover:to-orange-600 text-white font-bold py-3 rounded-xl shadow-xl transform hover:scale-105 active:scale-95 transition-all duration-300 border-0 relative overflow-hidden"
                >
      ...
      <section className="relative bg-gradient-to-br from-[#0D1321] via-[#1D2D44] to-[#3E5C76] text-primary-foreground py-12 sm:py-16 lg:py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {/* Floating particles */}
          <div className="absolute top-20 left-1/4 w-2 h-2 bg-white/30 rounded-full animate-bounce" style={{animationDelay: '0s'}}></div>
          <div className="absolute top-32 right-1/3 w-3 h-3 bg-amber-400/40 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
          <div className="absolute bottom-40 left-1/3 w-2 h-2 bg-blue-400/30 rounded-full animate-bounce" style={{animationDelay: '2s'}}></div>
        </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="mb-6 sm:mb-8">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-4 sm:mb-5 leading-tight tracking-tight">
                <span className="block bg-gradient-to-r from-white via-amber-100 to-white bg-clip-text text-transparent drop-shadow-2xl font-extrabold relative">
                  Find Workers in{' '}
                  <span className="bg-gradient-to-r from-amber-400 via-orange-400 to-red-400 bg-clip-text text-transparent animate-pulse font-black relative">
                    Minutes
                    <span className="absolute -inset-1 bg-gradient-to-r from-amber-400/20 to-red-400/20 blur-lg rounded-lg animate-pulse"></span>
                  </span>
                  <span className="ml-3 text-yellow-300 animate-bounce text-5xl lg:text-6xl drop-shadow-lg filter brightness-125">⚡</span>
                </span>
              </h2>
              <p className="text-lg sm:text-xl lg:text-2xl mb-4 max-w-3xl mx-auto px-4 font-bold leading-relaxed">
                ...
                🛡️ <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Trusted</span>
              </p>
              <p className="text-base sm:text-lg lg:text-xl text-white/90 max-w-2xl mx-auto px-4 leading-relaxed font-medium">
                Connect with <span className="text-amber-400 font-bold">1000+ verified professionals</span> ready to help!
              </p>
            </div>

            {/* Compact Action Cards with Effects */}
            <div className="flex flex-col lg:flex-row gap-5 justify-center px-4 max-w-4xl mx-auto">
              {/* Customer Card */}
              <div className="group relative flex-1 max-w-sm mx-auto lg:mx-0">
                <Card className="relative p-5 sm:p-6 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.03] border border-gray-100 hover:border-amber-200 overflow-hidden group-hover:-translate-y-1">
                  ...
                  <div className="text-center relative z-10">
                    ...
                    <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-r from-amber-50 to-orange-50 rounded-full mb-4 group-hover:scale-110 group-hover:shadow-lg transition-all duration-300 group-hover:animate-pulse">
                    ...
                    <div className="mb-5">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mb-3">
                        Post projects and get instant quotes from verified professionals
                      </p>
                      ...
                      <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-50 rounded-full mb-4 group-hover:bg-amber-100 transition-colors duration-300">
                        ...
                        <span className="text-xs font-medium text-amber-700">5min avg response</span>
                      </div>
                    </div>
              ...
              {/* Worker Card */}
              <div className="group relative flex-1 max-w-sm mx-auto lg:mx-0">
                <Card className="relative p-5 sm:p-6 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.03] border border-gray-100 hover:border-blue-200 overflow-hidden group-hover:-translate-y-1">
                  {/* Animated gradient overlay */}
                  ...
                  <div className="text-center relative z-10">
                    {/* Icon with floating effect */}
                    <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full mb-4 group-hover:scale-110 group-hover:shadow-lg transition-all duration-300 group-hover:animate-pulse">
                    ...
                    <div className="mb-5">
                      ...
                      <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 rounded-full mb-4 group-hover:bg-blue-100 transition-colors duration-300">
                        ...
                        <span className="text-xs font-medium text-blue-700">500+ earning daily</span>
                      </div>
                    </div>
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center text-white/80">
              <div className="flex items-center gap-2 text-sm font-medium">
                ...
                <span>4.9/5 from <span className="text-yellow-400 font-bold">10K+</span> users</span>
              </div>
              <div className="flex items-center gap-2 text-sm font-medium">
                <Shield className="w-4 h-4 text-green-400" />
                <span>All workers <span className="text-green-400 font-bold">verified</span></span>
              </div>
              <div className="flex items-center gap-2 text-sm font-medium">
                <Clock className="w-4 h-4 text-blue-400" />
                <span><span className="text-blue-400 font-bold">24/7</span> support</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-white/80 text-base sm:text-lg leading-relaxed mb-4">
                Connecting skilled workers with customers for quick, reliable service nationwide.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-white/80 text-sm sm:text-base">
                <li className="hover:text-white transition-colors cursor-pointer">Find Jobs</li>
                <li className="hover:text-white transition-colors cursor-pointer">Build Profile</li>
                <li className="hover:text-white transition-colors cursor-pointer">Get Paid</li>
                <li className="hover:text-white transition-colors cursor-pointer">Worker Dashboard</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-white/80 text-sm sm:text-base">
                ...
                <li className="hover:text-white transition-colors cursor-pointer">Hire Workers</li>
                <li className="hover:text-white transition-colors cursor-pointer">Manage Projects</li>
                <li className="hover:text-white transition-colors cursor-pointer">Customer Dashboard</li>
              </ul>
            </div>
